...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	  ...
	  $style = (0, _jquery2.default)('<style></style>');
	  ...
	  reload_images = function reload_images() {
	    ...
	    images.length = 0;
	    for (i = j = 0, ref = Math.min(1000, (0, _jquery2.default)('#images').val() - 1); 0 <= ref ? j <= ref : j >= ref; i = 0 <= ref ? ++j : --j) {
	      images.push({
	        id: i,
	    ...
	    reload_layout();
	    return processing_images = false;
	  };
	  ...
	  reload_stats = _lodash2.default.throttle(function () {
	    var $items, max, sum;
	    max = 0;
	    sum = 0;
	    $items = (0, _jquery2.default)('.i');
	    $items.each(function (i, e) {
	      var height;
	      height = (0, _jquery2.default)(e).outerHeight();
	      max = Math.max(height, max);
	      return sum += height;
	    });
	    (0, _jquery2.default)('#height_max').html(Math.round(max, 2));
	    return (0, _jquery2.default)('#height_avg').html(Math.round(sum / $items.length, 2));
	  }, 200);
	  (0, _jquery2.default)(window).on('resize', reload_stats);
	  on_change = function on_change(selector, callback) {
	  ...
	  return on_change('#margin', reload_layout);
	});
